<x-app-layout>
	<x-slot name="title">Daftar Gejala Penyakit TB</x-slot>
						...
						<td>
							<div class="d-flex justify-between-space">
								...
								<form action="{{ route('admin.gejala.destroy', $row->id) }}" method="post">
									@csrf
									<button type="submit" class="btn btn-danger btn-sm ml-1 delete">hapus</button>
								</form>
							</div>
						</td>
					</tr>
	...
	<x-modal title="Tambahkan Gejala Penyakit TB" id="gejala">
	...
	<x-modal title="Edit Gejala Penyakit TB" id="edit-gejala">
