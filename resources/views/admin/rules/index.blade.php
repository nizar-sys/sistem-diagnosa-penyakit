<x-app-layout>
	...
	<x-slot name="title">Nilai Gejala Tuberkulosis</x-slot>
				...
				<div class="table-responsive">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $row->nama }}</td>
								<td>
									<input style="min-width: 2.5rem" type="number" step="0.2" class="form-control form-control-sm" value="{{ $row->pivot->value_cf }}" name="gejala-{{ $row->id }}">
								</td>
								<td>
